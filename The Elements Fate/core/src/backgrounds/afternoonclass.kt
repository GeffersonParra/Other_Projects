...
class afternoonclass(var x: Int, var y: Int, gameStateManager: GameStateManager?) : State(gameStateManager) {

    private val batch: SpriteBatch = SpriteBatch()
    private val texture: Texture = Texture("backgrounds/afternoon.png")
    private lateinit var animation: Animation<TextureRegion>
    private var elapsedTime: Float = 0f

    init {
        // Define the number of rows and columns in the sprite sheet
        val rows = 9  // Adjust based on your sprite sheet layout
        val cols = 5  // Adjust based on your sprite sheet layout
