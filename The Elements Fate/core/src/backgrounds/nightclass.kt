...
class nightclass(var x: Int, var y: Int, gameStateManager: GameStateManager?) : State(gameStateManager) {

    private val batch: SpriteBatch = SpriteBatch()
    private val texture: Texture = Texture("backgrounds/night.png")
