...
class levelOne(gameStateManager: GameStateManager?) : State(gameStateManager) {
    ...
    fun create() {
        ...
        map = TmxMapLoader().load("levels/prueba.tmx")
        if (map != null) {
        ...
        player1 = PlayerOne(100, 180)
        player2 = PlayerTwo(200, 180)
